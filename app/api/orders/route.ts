...
export async function GET(req: NextRequest) {
  ...
  // Default: only active orders (waiting/received) - the dashboard active
  // panel depends on this. With ?history=1, return the full order history
  // (all statuses) for the My Numbers page.
